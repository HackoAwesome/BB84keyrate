...
The aim of this project is to create a tool to perform numerical analysis on the **key rate of an Entanglement-Based BB84 protocol**. The tool is based on the theoretical bounds proposed in [arXiv:2405.05912](https://arxiv.org/pdf/2405.05912)(eqn. 145).

## Features

- Computes **finite-size key rate bounds** for EB-BB84.
- Performs **convex optimization** to evaluate the bounds using cvxpy.
- Utilises **piecewise-linear approximations** for non-atomic functions on cvxpy variables. 
